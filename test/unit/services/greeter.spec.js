...
describe("Test 'greeter' service", () => {
	...
	describe("Test 'greeter.testing' action", () => {

		it("should return with 'Test Moleculer'", async () => {
			const res = await broker.call("greeter.testing");
			expect(res).toBe("Test Moleculer");
		});
